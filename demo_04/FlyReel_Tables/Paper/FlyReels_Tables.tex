...
We plot the correlation between fly reel prices and numerical variables. 
Table \ref{tab:correlation_num} shows the correlation 
between the log.~of house sale prices
and the numeric variables weight, diameter, and width.
All three variables are positively correlated with prices. 

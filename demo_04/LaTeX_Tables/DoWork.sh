...
echo "#-------------------------------------------------"
echo ""
echo "Building the first pdf Document with LaTeX..."
echo ""
...
pdflatex -shell-escape Paper_w_Table.tex
...
echo "#-------------------------------------------------"
echo ""
echo "Building the second pdf Document with LaTeX..."
echo ""

# We need options for extra permission in the VirtualBox machine.
pdflatex -shell-escape Paper_w_Table_Separate.tex
...
echo "Finished building both pdf documents with LaTeX."
echo ""
echo "#-------------------------------------------------"
echo ""
